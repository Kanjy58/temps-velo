...
if(options.center){var textLength=textNode.getComputedTextLength();var pathLength=this._path.getTotalLength();textNode.setAttribute('dx',((pathLength/2)-(textLength/2)));}
